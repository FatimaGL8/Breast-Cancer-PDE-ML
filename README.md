...
$$
\begin{cases}
\partial_t c - \nabla \cdot (D(x)\nabla c) = a c \ln\left(\frac{K}{c}\right) - \gamma c \beta & en Q,
\partial_t \beta - \mu \Delta \beta = -\delta \beta + u(t) & en Q.
\end{cases}
$$
...
$$
\begin{aligned}
\frac{\partial c}{\partial n} = 0, \quad \frac{\partial \beta}{\partial n} = 0 & en \partial\Omega \times (0,T), \\[1ex]
c(x,0)=c_0(x), \quad \beta(x,0)=\beta_0(x) & en \Omega.
\end{aligned}
$$
